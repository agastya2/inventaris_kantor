...
<div class="container-fluid">
    <h1 class="h3 mb-4 text-gray-800 text-center">Tambah Barang</h1>

    <div class="form-container">
        <form action="/barang/store" method="post" class="user">
            <?= csrf_field() ?>

            <div class="form-group row">
                <label for="kode_barang" class="col-sm-3 col-form-label">Kode Barang <span class="text-danger">*</span></label>
                <div class="col-sm-9">
                    <input type="text" name="kode_barang" id="kode_barang" class="form-control form-control-user" required>
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <input type="text" name="nama_barang" id="nama_barang" class="form-control form-control-user" required>
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <textarea name="keterangan" id="keterangan" rows="4" class="form-control form-control-user"></textarea>
                </div>
            </div>
